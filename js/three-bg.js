...
const CONFIG = {
    colorNiebla: 0x331133,
    nieblaInicio: 90.0,
    nieblaFin: 1.0,
    colorGeometria: 0x991C99,
    colorLuzToque: 0x009A9D,
    intensidadLuzBase: 666,
    intensidadLuzToque: 777,
    colorLuzAmbiente: 0x991199,
    intensidadAmbiente: 25.00,
    distanciaCamara: 25.5,
    campoVision: 20,
    radio: 2.0,
    detalle: window.innerWidth < 640 ? 4 : 20, 
    rugosidad: 3.33,
    metalizado: 1.0,
    flatShading: true,
    escalaTiempo: 0.00010,
    velRotacionX: 0.155,
    velRotacionY: 3.155,
    amplitudRotZ: 0.99,
    frecuenciaRotZ: 0.05,
